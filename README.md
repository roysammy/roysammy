...
### Publications
- Soumyajit Roy, Manav Malhotra. (2026). **ModusPonens at SemEval-2026 Task 11: Breaking the Plausibility Trap in LLMs via Conflict-Aware Ensembling**. In *Proceedings of the 20th International Workshop on Semantic Evaluation (SemEval-2026)* (pp. 65–71). San Diego, California, USA: Association for Computational Linguistics. DOI: [10.18653/v1/2026.semeval-1.10 ↗](https://aclanthology.org/2026.semeval-1.10/)
- Soumyajit Roy. (2026). **Ambirig at SemEval-2026 Task 5: Distributional Ordinal Modelling for Ambiguous Word Senses in Narrative Contexts**. In *Proceedings of the 20th International Workshop on Semantic Evaluation (SemEval-2026)* (pp. 585–591). San Diego, California, USA: Association for Computational Linguistics. DOI: [10.18653/v1/2026.semeval-1.84 ↗](https://aclanthology.org/2026.semeval-1.84/)
